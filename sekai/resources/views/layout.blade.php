     ...
     <nav class="navbar navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="/sekai/">
                            <img src="{{ asset('public/img/Sekai.png') }}" alt="nav-logo" style="height:50px; width:100px"/>
                        </a>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="/sekai/" class="dropdown-toggle">Home</a>
                            </li>
                            <li class="">
                                <a href="/sekai/menu" class="dropdown-toggle">Menu</a>
                            </li>
                            <li class="">
                                <a href="/sekai/reservation" class="dropdown-toggle">Reservation</a>
                            </li>
                            <li class="">
                                <a href="/sekai/about" class="dropdown-toggle">About us</a>
                            </li>
                            <li class="">
                                <a href="/sekai/gallery" class="dropdown-toggle">Gallery</a>
                            </li>
                            <li class="">
                                <a href="/sekai/shop" class="dropdown-toggle">Shop</a>
                            ...
                            <li><a href="/sekai/contact">Contact</a></li>
                            <li class="dropdown" id="header-bar">
                                ...
                                <div class="cart-content dropdown-menu">
                                    ...
                                    <div class="cart-action clearfix">
                                        ...
                                        <a class="btn btn-default pull-right" href="/sekai/cart">View Cart</a>
                                    </div>
                                </div>
                            </li>
                            @if(\Illuminate\Support\Facades\Auth::check())
                             ...
                             <ul class="dropdown-menu">
                             <li><a href="/sekai/profile">My Profile</a></li>
                             <li><a href="/sekai/orders">My Orders</a></li>
                              <li><a href="/sekai/logout">Logout</a></li>
                            </ul>
                             </li>
                            @else 
                            <li><a href="/sekai/account">Account</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
