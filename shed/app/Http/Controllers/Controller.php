...
class Controller extends BaseController
{
    ...
    public function home(Request $request)
    {
        ...
        $menuHome = DB::select('select * FROM shed_menu Where item_status IN("Available") ORDER BY created_at DESC LIMIT 10');
        $specials = DB::select('select * FROM shed_menu Where specials="Yes" AND item_status IN("Available") ORDER BY created_at DESC');
    ...
    {
        $menuAbout = DB::select('select * FROM shed_menu Where item_status IN("Available") ORDER BY created_at DESC LIMIT 10');
    ...
    public function menuCategory(Request $request, $category)
    {
        ...
        $cat =  DB::select("SELECT * FROM shed_categories WHERE category='$category'");
        ...
        if ($request->ajax()) {
            foreach ($products as $key => $products) {
                ...
                <div class="product-info">
                    ...
                    <h4><a href="/shed/menu_Item_detail/'.$products->id.'">'.$products->name.'</a></h4>
                    <div class="rc-ratings">
