 ...
 @section('title', 'Menu Item')
    ...
    <div class="content-box">
        <div class="row">
            <div class="col-md-8">
                <div class="order-box">
                     <div class="form-group"><a href="{{url('sekaiMenu')}}" class="btn btn-success">Back</a></div>
                    ...
                    <div class="order-controls">
                        <form class="form-inline" action="{{ route('sekai_menu_data.updateMenuStatus',$MenuData->id) }}" method="POST">
                          {{ csrf_field() }}
                          {{ method_field('get') }}
                    ...
                    <div class="order-items-table">
                        <div class="table-responsive">
                            <table class="table table-lightborder">
                                ...
                                <tbody>
                                    <tr>
                                        <td> <?php if (!empty($MenuData->pic)){?><div class="product-image"><img alt="" src="{{ asset($MenuData->pic) }}"  style="width:100px; height:80px; border:1px solid #ccc;padding:5px 5px 5px 5px"/></div><?php }else{?> <div class="product-image"><img alt="" src="{{ asset('public/sekai/img/empty.jpg') }}" style="width:100px; height:70px; border:1px solid #ccc;padding:5px 5px 5px 5px"/></div><?php }?></td>
                                        <td>
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('sekai_menu_data.itemOrderHistory',$MenuData->id) }}" class="btn btn-secondary" style="margin-left:100px">Item Order History</a>
                </div>
            </div>
        </div>
