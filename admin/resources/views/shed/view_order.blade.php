 ...
 @section('title', 'View Order Item')
    ...
    <div class="content-box">
        <div class="row">
            <div class="col-md-8">
                <div class="order-box">
                     <div class="form-group"><a href="{{url('shedOrders')}}" class="btn btn-success">Back</a></div>
                    ...
                    <div class="order-controls">
                        <form class="form-inline" action="{{ route('shed_order_data.update',$Orders->id ) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                ...
                <div class="ecommerce-customer-info">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="ecc-sub-info-row">
                            ...
                            <div class="sub-info-value"><img alt="" src="{{ asset('public/shed/img/mastercard.png') }}" style="width: auto; height: 40px;" /><span>{{ $Orders->payment_method }}</span></div>
                        </div>
                    </div>
                </div>
            </div>
