    ...
    <div class="element-wrapper">
        <div class="element-box">
          ...
          @endif
            ...
            <form id="formValidate" action="{{ route('sekai_menu_data.update',$MenuData->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="element-info">
                    <div class="element-info-with-icon">
                        ...
                        <div class="element-info-text">
                            <h5 class="element-inner-header">Edit Menu Item  <a class="mr-2 mb-2 btn btn-success btn-xs" href="{{url('sekaiMenu')}}" style="margin-left:300px">Back</a></h5>
