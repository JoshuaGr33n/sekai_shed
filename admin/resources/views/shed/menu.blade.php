                         ...
                         <tr>
                            ...
                            <td>#{{ $menu->price}}</td>
                             ...
                             <td>{{ $menu->specials}}</td>
                               ...
                               <form action="{{ route('shed_menu_data.destroy',$menu->id) }}" method="POST">
                                  <a href="{{ route('shed_menu_data.show',$menu->id) }}" class="btn btn-info btn-xs"><i class="os-icon os-icon-external-link"></i></a>
                                  <a href="{{ route('shed_menu_data.edit',$menu->id) }}" class="btn btn-primary btn-xs" style="margin-left:0px;"><i class="os-icon os-icon-ui-49"></i></a>
                                  ...
                                  @include('shed.menu_delete_modal')
                                </form>
                                  </td>
                         </tr>
            ...
            <div class="modal-body">
             ...
             @if ($errors->any())
              ...
              <ul>
               ...
               @endif
                <form role="form" method="POST" action="{{ route('shed_menu_data.store') }}" id="formValidate" enctype="multipart/form-data">
                             {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div>
                            <button type="submit" class="btn btn-success btn-xs" style="width:515px; height:40px">
                                Add
                            </button>
                        </div>
                    </div>
