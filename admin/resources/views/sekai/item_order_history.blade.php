                        ...
                        <tbody>
                           @foreach ($itemOrders as $itemOrders)
                            <tr>
                                ...
                                <td class="text-right">
                                <form action="{{ route('sekai_menu_data.deleteItemOrder',$itemOrders->id) }}" method="POST">
                                 <a href="{{ route('sekai_order_data.show',$itemOrders->id) }}" class="btn btn-info btn-xs"><i class="os-icon os-icon-external-link"></i></a>
                                  ...
                                  @include('sekai.item_order_history_delete_modal')
                             </form>
                                </td>
                            </tr>
                            @endforeach
