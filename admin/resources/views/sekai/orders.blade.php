                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                              <form action="{{ route('sekai_order_data.destroy',$orders->id) }}" method="POST">
                                 <a href="{{ route('sekai_order_data.show',$orders->id) }}" class="btn btn-info btn-xs"><i class="os-icon os-icon-external-link"></i></a>
                                  ...
                                  @include('sekai.orders_delete_modal')
                             </form>
                            </td>
                        </tr>
                        @endforeach
