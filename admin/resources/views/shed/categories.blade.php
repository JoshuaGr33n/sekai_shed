                ...
                <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                                    <?php 
                                      $check_menu_category = DB::select("SELECT * FROM shed_menu WHERE category like '%$categories->category%'");
                                      ?>
                                 <form action="{{ route('shed_categories_data.update',$categories->id) }}" method="POST">
                                   {{ csrf_field() }}
                                   {{ method_field('PATCH') }}
                                  ...
                                  @include('shed.edit_categories_modal')
                                  </form>
                                  </td>
                                  <td> 
                                  <form action="{{ route('shed_categories_data.destroy',$categories->id) }}" method="POST">
                                  {{-- @csrf
                                   @method('DELETE') --}} 
            ...
            <div class="modal-body">
             ...
             @if ($errors->any())
              ...
              <ul>
               ...
               @endif
                <form  method="POST" action="shed_store_category"  class="btn-submit" id="formValidate">
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div>
                            <button class="btn btn-success btn-xs" style="width:515px; height:40px">
                                Add
                            </button>
                        </div>
                    </div>
